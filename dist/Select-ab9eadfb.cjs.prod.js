...
var shouldHideSelectedOptions = function(props) {
  ...
  return _createClass__default.default(Select, [ {
    ...
    key: "getCommonProps",
    value: function() {
      var clearValue = this.clearValue, closeMenu = this.closeMenu, blurInput = this.blurInput, focusInput = this.focusInput, cx = this.cx, getStyles = this.getStyles, getValue = this.getValue, selectOption = this.selectOption, setValue = this.setValue, props = this.props, isMulti = props.isMulti, isRtl = props.isRtl, options = props.options, isFocused = this.state.isFocused;
      return {
      ...
      if (this.hasOptions()) menuUI = this.getCategorizedOptions().map((function(item) {
        if ("group" === item.type) {
          ...
          return React__namespace.createElement(Group, _extends__default.default({}, commonProps, {
            ...
            headingProps: index._objectSpread2(index._objectSpread2({}, commonProps), {}, {
              id: headingId,
              data: item.data
            }),
