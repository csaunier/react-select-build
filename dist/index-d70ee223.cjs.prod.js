...
var _excluded$3 = [ "className", "clearValue", "closeMenu", "blurInput", "focusInput", "cx", "getStyles", "getValue", "hasValue", "isFocused", "isMulti", "isRtl", "options", "selectOption", "selectProps", "setValue", "theme" ], noop = function() {};
...
var cleanValue = function(value) {
  ...
  return props.className, props.clearValue, props.closeMenu, props.blurInput, props.focusInput, 
  props.cx, props.getStyles, props.getValue, props.hasValue, props.isFocused, props.isMulti, 
  props.isRtl, props.options, props.selectOption, props.selectProps, props.setValue, 
  props.theme, _objectSpread2({}, _objectWithoutProperties__default.default(props, _excluded$3));
};
